	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-hero': 'linear-gradient(135deg, #0A0A0F 0%, #1A1A2E 30%, #16213E 70%, #0F172A 100%)',
				'gradient-card': 'linear-gradient(145deg, rgba(26, 26, 46, 0.8) 0%, rgba(22, 33, 62, 0.6) 100%)',
			...
			boxShadow: {
				...
				'cyber-lg': '0 16px 64px rgba(0, 0, 0, 0.4)',
			...
			keyframes: {
				...
				'text-glow': {
					...
					'50%': {
						textShadow: '0 0 40px rgba(0, 217, 255, 0.8), 0 0 60px rgba(168, 85, 247, 0.3)'
					}
				},
				'slide-up': {
					'0%': {
			...
			animation: {
				...
				'building-rise': 'building-rise 2s ease-out forwards',
